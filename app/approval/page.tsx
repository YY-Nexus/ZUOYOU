...
export default function ApprovalPage() {
  ...
  useEffect(() => {
    ...
    if (typeFilter !== "all") {
      ...
      filtered = filtered.filter((approval) => approval.type === typeMap[typeFilter])
    }
  ...
  const displayApprovals = filteredApprovals.length > 0 ? filteredApprovals : approvals
          ...
          <CardHeader>
            ...
            <CardDescription>
              ...
              {searchTerm || statusFilter !== "all" || typeFilter !== "all"
                ? ` (显示 ${displayApprovals.length} 条结果)`
                : ` (共 ${totalApprovals} 条)`}
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              ...
              {displayApprovals.length === 0 && (
                <div className="text-center py-12">
                  ...
                  <h3 className="text-lg font-medium text-gray-900 mb-2">暂无匹配的审批申请</h3>
