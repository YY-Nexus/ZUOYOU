  ...
  const menuItems: MenuItem[] = [
    ...
    },
    {
      ...
      children: [
        ...
        { title: "文件传输", icon: FileUp, href: "/communication/files" },
      ],
    },
    {
      title: "AI分析",
    ...
    },
    {
      ...
      children: [
        ...
        { title: "多因素认证", icon: ChevronRight, href: "/security/mfa" },
            ...
            {!collapsed || isMobile ? (
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  >
                    <span className={cn("text-white font-bold", isMobile ? "text-base" : "text-sm")}>YY</span>
                  </div>
                  <div>
                    <h2
                      className={cn(
              ...
              <div className="flex justify-center">
                <div className="w-8 h-8 bg-gradient-to-br from-sky-400 to-blue-600 rounded-lg flex items-center justify-center">
                  <span className="text-white font-bold text-sm">YY</span>
                </div>
              </div>
            )}
          </div>
