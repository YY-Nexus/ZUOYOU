          ...
          <Tabs defaultValue="dashboard" className="w-full">
            ...
            <TabsContent value="insights" className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div className="p-3 bg-green-50 rounded-lg border-l-4 border-green-400">
                        <h4 className="font-medium text-green-800">销售增长机会</h4>
                        <p className="text-sm text-green-700">华南地区客户转化率提升23%，建议加大投入</p>
                      </div>
                      <div className="p-3 bg-blue-50 rounded-lg border-l-4 border-blue-400">
                        <h4 className="font-medium text-blue-800">客户行为趋势</h4>
                        <p className="text-sm text-blue-700">移动端访问量占比达到68%，需优化移动体验</p>
                      </div>
                      <div className="p-3 bg-yellow-50 rounded-lg border-l-4 border-yellow-400">
                        <h4 className="font-medium text-yellow-800">成本优化建议</h4>
                        <p className="text-sm text-yellow-700">运营成本可通过自动化流程降低15%</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-white/80 backdrop-blur-sm border border-sky-200 rounded-xl shadow-sm hover:shadow-md transition-all duration-200">
                  <CardHeader>
                    <CardTitle className="text-base">市场竞争分析</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                        <span className="text-sm">市场份额</span>
                        <span className="text-lg font-bold text-blue-600">23.5%</span>
                      </div>
                      <div className="w-full h-2 bg-sky-100 rounded-full overflow-hidden">
                        <div className="w-1/4 h-full bg-gradient-to-r from-blue-400 to-blue-500 rounded-full"></div>
                      </div>
                      <div className="grid grid-cols-2 gap-4 mt-4">
                        <div className="text-center p-2 bg-green-50 rounded">
                          ...
                          <div className="text-xs text-green-700">同比增长</div>
                        </div>
                        <div className="text-center p-2 bg-blue-50 rounded">
                          <div className="text-lg font-bold text-blue-600">排名第3</div>
                          <div className="text-xs text-blue-700">行业地位</div>
                        </div>
                      </div>
                    </div>
                  </CardContent>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Card className="bg-white/80 backdrop-blur-sm border border-sky-200 rounded-xl shadow-sm hover:shadow-md transition-all duration-200">
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div className="flex justify-between items-center">
                        <span className="text-sm">下月预测销售额</span>
                        <span className="text-lg font-bold text-green-600">¥2,890,000</span>
                      </div>
                      <div className="space-y-2">
                        <div className="flex justify-between text-sm">
                          <span>预测准确率</span>
                          <span className="text-blue-600">87.3%</span>
                        </div>
                        <div className="w-full h-2 bg-sky-100 rounded-full overflow-hidden">
                          <div className="w-5/6 h-full bg-gradient-to-r from-green-400 to-green-500 rounded-full"></div>
                        </div>
                      </div>
                      <div className="p-3 bg-green-50 rounded-lg">
                        <p className="text-sm font-medium text-green-800">预测趋势</p>
                        <p className="text-xs text-green-600">基于历史数据和市场趋势，预计增长17.6%</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-white/80 backdrop-blur-sm border border-sky-200 rounded-xl shadow-sm hover:shadow-md transition-all duration-200">
                  <CardHeader>
                    <CardTitle className="text-base">风险预警</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-3">
                      <div className="p-3 bg-red-50 rounded-lg border-l-4 border-red-400">
                        <h4 className="font-medium text-red-800">高风险</h4>
                        <p className="text-sm text-red-700">客户流失率上升，需要关注客户满意度</p>
                      </div>
                      <div className="p-3 bg-yellow-50 rounded-lg border-l-4 border-yellow-400">
                        <h4 className="font-medium text-yellow-800">中风险</h4>
                        <p className="text-sm text-yellow-700">库存周转率下降，建议优化库存管理</p>
                      </div>
                      <div className="p-3 bg-green-50 rounded-lg border-l-4 border-green-400">
                        <h4 className="font-medium text-green-800">低风险</h4>
                        <p className="text-sm text-green-700">现金流状况良好，财务风险较低</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
